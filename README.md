...
`.\main.exe B2` - Shows up to 50 crimes in B2

`.\main.exe B2 10` - Shows top 10 crimes from each heap

`.\main.exe B2 0` - Shows ALL crimes in B2

`.\main.exe C11 5` - Top 5 in C11
